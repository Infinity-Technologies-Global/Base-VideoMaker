...
class Config() : Parcelable {
    ...
    lateinit var selectedImageModels: ArrayList<ImageModel>
    ...
    constructor(parcel: Parcel) : this() {
        ...
        selectedImageModels = parcel.createTypedArrayList(ImageModel.CREATOR)!!
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        ...
        parcel.writeTypedList(selectedImageModels)
