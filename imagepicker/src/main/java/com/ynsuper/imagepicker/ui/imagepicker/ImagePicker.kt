...
import com.ynsuper.imagepicker.ui.camera.CameraActivity
import java.util.*
...
class ImagePicker(builder: Builder) {
    ...
    abstract class Builder : BaseBuilder {
        ...
        fun setSelectedImages(selectedImageModels: ArrayList<ImageModel>?): Builder {
            config.selectedImageModels = selectedImageModels ?: arrayListOf()
            return this
        }
    ...
    abstract class BaseBuilder(context: Context?) {
        ...
        init {
            ...
            config.selectedImageModels = arrayListOf()
        }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun getImages(data: Intent): ArrayList<ImageModel>? {
