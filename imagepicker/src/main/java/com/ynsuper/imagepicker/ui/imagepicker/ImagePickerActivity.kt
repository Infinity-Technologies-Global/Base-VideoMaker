...
import com.ynsuper.imagepicker.helper.*
import com.ynsuper.imagepicker.listener.OnFolderClickListener
...
import com.ynsuper.imagepicker.ui.camera.DefaultCameraModule
import com.ynsuper.imagepicker.ui.camera.OnImageReadyListener
...
class ImagePickerActivity : AppCompatActivity(), OnFolderClickListener, OnImageSelectListener {
    ...
    private fun finishPickImages(imageModels: ArrayList<ImageModel>) {
        val data = Intent()
    ...
    override fun onSelectedImagesChanged(selectedImageModels: ArrayList<ImageModel>) {
        viewModel.selectedImages.value = selectedImageModels
    }

    override fun onSingleModeImageSelected(imageModel: ImageModel) {
        finishPickImages(ImageHelper.singleListFromImage(imageModel))
    }
}