...
import com.ynsuper.imagepicker.helper.CameraHelper.checkCameraAvailability
import com.ynsuper.imagepicker.helper.LogHelper.Companion.instance
import com.ynsuper.imagepicker.helper.PermissionHelper.hasGranted
import com.ynsuper.imagepicker.helper.PermissionHelper.hasSelfPermission
import com.ynsuper.imagepicker.helper.PermissionHelper.hasSelfPermissions
import com.ynsuper.imagepicker.helper.PermissionHelper.openAppSettings
import com.ynsuper.imagepicker.helper.PermissionHelper.requestAllPermissions
import com.ynsuper.imagepicker.helper.PermissionHelper.shouldShowRequestPermissionRationale
import com.ynsuper.imagepicker.helper.PreferenceHelper.firstTimeAskingPermission
import com.ynsuper.imagepicker.helper.PreferenceHelper.isFirstTimeAskingPermission
import com.ynsuper.imagepicker.helper.ToastHelper
...
class CameraActivity : AppCompatActivity() {
    ...
    private fun finishCaptureImage() {
        cameraModule.getImage(this, config!!.isCameraOnly, object : OnImageReadyListener {
            override fun onImageReady(imageModels: ArrayList<ImageModel>) {
                val data = Intent()
                data.putParcelableArrayListExtra(Config.EXTRA_IMAGES, imageModels)
