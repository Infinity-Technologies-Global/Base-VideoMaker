...
import com.ynsuper.imagepicker.ui.adapter.FolderPickerAdapter
...
class FolderFragment : BaseFragment() {
    ...
    private fun handleResult(result: Result) {
        if (result.status is CallbackStatus.SUCCESS && result.imageModels.isNotEmpty()) {
            val folders = ImageHelper.folderListFromImages(result.imageModels)
