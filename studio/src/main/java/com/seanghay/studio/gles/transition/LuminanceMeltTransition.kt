...
open class LuminanceMeltTransition : Transition("luminance-melt", SOURCE, 1000L,"transition_37") {

    open var direction: Boolean = true
    open var directionUniform = BooleanUniform("direction").autoInit()
    open var lThreshold: Float = 0.8f
    ...
    override fun onUpdateUniforms() {
        ...
        lThresholdUniform.setValue(lThreshold)
        aboveUniform.setValue(above)
    }
